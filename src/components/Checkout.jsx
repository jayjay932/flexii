...
function Checkout() {
  ...
  useEffect(() => {
    fetch(`http://localhost/flexii/api/checkout.php?id=${id}`)
      .then(res => res.json())
      .then(data => {
        if (data && data.listing) {
          ...
          console.warn('Aucun listing trouvé pour cet ID :', id);
          setListing(null);
        }
        setLoading(false);
      })
  ...
  const totalPrice = nbNuits * listing.price_per_night;
      ...
      <div className="checkout-wrapper">
        <div className="checkout-left">
          ...
          <div className="section">
            ...
            <Link to={`/listing/${id}`} className="cancel-link">Annuler</Link>
          </div>
        ...
        <div className="checkout-right">
          ...
          <div className="section">
            ...
            <div className="price-detail">
              <p>Prix : {listing.price_per_night.toFixed(2)} € x {nbNuits} nuits</p>
